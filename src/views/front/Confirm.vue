<template>
  <section class="p-7">
    <p class="h1 d-flex">
      ...
      ><span style="animation-delay: calc(1s * 0.2);" data-aos="animate__rotateInDownLeft">確</span
      ><span style="animation-delay: calc(1s * 0.3);" data-aos="animate__rotateInDownLeft">認</span
      ><span style="animation-delay: calc(1s * 0.4);" data-aos="animate__rotateInDownLeft">資</span
      ><span style="animation-delay: calc(1s * 0.5);" data-aos="animate__rotateInDownLeft">料</span
      ><span style="animation-delay: calc(1s * 0.6);" data-aos="animate__rotateInDownLeft">。</span>
    </p>
  </section>
  <!-- 訂單資訊 -->
  <section class="d-flex justify-content-center mb-8">
    <ol class="triangle p-0">
      <li class="rounded-start">購買</li>
      <li class="current">支付</li>
      <li>確認</li>
      <li class="rounded-end">完成</li>
    </ol>
  </section>
  <!-- 付款方式 -->
      ...
      <div class="col-4">
        ...
        <div class="form-check d-flex align-items-center border-top py-3">
          <input
            ...
            checked
          />
          <label class="form-check-label h3" for="flexRadioDefault4">
            超商帳單代收
          </label>
        </div>
        <div class="form-check d-flex align-items-center border-top py-3">
        ...
        <div class="d-flex justify-content-center">
          <button type="buttom" class="btn btn-dark mb-6 magnifyText">下一步</button>
        </div>
      </div>
      <div class="col-4"></div>
    </div>
